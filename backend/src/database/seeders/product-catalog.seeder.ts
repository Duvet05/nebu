...
export async function seedProducts(dataSource: DataSource): Promise<void> {
  ...
  const products = [
    ...
    },
    {
      ...
      shortDescription: 'Aventureros cósmicos con traje espacial LED y mochila de propulsión',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Felino travieso del multiverso con detalles holográficos brillantes',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Guardián cósmico con alas holográficas y acabado metalizado',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Pequeño gruñón con expresión única y pelaje texturizado realista',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Bufón de píxeles retro con diseño inspirado en videojuegos clásicos',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Conejo místico con orejas extra largas y pelaje nacarado',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Criatura marina con mandíbula articulada y dientes de goma suave',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
    ...
    },
    {
      ...
      shortDescription: 'Conejito de algodón de azúcar con textura suave y aroma a vainilla',
      price: 260.0,
      depositAmount: 130.0,
      inStock: false,
      preOrder: true,
