...
-- Insertar productos desde el CSV
-- NOTA: images y features son simple-array (texto separado por comas, vacío = '')
-- colors es jsonb (array JSON)

INSERT INTO product_catalog (slug, name, concept, "originalCharacter", description, price, "depositAmount", "inStock", "preOrder", images, colors, features, category, badge, active) VALUES
...
-- Mostrar resumen
SELECT COUNT(*) as total_productos, COUNT(CASE WHEN active = true THEN 1 END) as activos FROM product_catalog;

-- Mostrar algunos productos
SELECT slug, name, concept, category, badge FROM product_catalog LIMIT 5;
